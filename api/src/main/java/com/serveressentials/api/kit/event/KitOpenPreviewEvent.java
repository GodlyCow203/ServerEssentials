...
public final class KitOpenPreviewEvent extends KitEvent {
    private final @NotNull String kitId;
    private final @NotNull String kitName;

    public KitOpenPreviewEvent(@NotNull Player player, @NotNull String kitId, @NotNull String kitName) {
        super(player);
    ...
    /**
     * Gets the ID of the kit being previewed.
     *
     * @return The kit ID
     */
    ...
    /**
     * Gets the display name of the kit being previewed.
     *
     * @return The kit name
     */
