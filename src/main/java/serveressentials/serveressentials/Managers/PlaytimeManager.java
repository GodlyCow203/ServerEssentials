...
public class PlaytimeManager {
    ...
    public PlaytimeManager(ServerEssentials plugin) {
        this.plugin = plugin;
        ...
        // Create /storage/ folder inside plugin folder
        File storageFolder = new File(pluginFolder, "storage");
        if (!storageFolder.exists()) {
            storageFolder.mkdirs();
        }

        // Set file path: plugins/ServerEssentials/storage/PlayTime.yml
        ...
        // Load online players (existing method)
        loadOnlinePlayers();
    }
