...
import serveressentials.serveressentials.util.ColorUtils;
...
public class KitManager {
    ...
    public static void reload() {
        KitConfigManager.reload(); // reload kits.yml from disk
        loadKits(KitConfigManager.getConfig()); // rebuild the in-memory kits map
        Bukkit.getLogger().info("[ServerEssentials] Kits reloaded successfully.");
    }
