...
public class EconomyManager {
    ...
    public static void setBalance(@NotNull UUID uuid, double amount) {
        ...
        System.out.println("Balance set for " + uuid + ": " + amount); // DEBUG LINE
        saveBalances();
    }
    ...
    public static void addBalance(@NotNull UUID uuid, double amount) {
        ...
        saveBalances();
        Bukkit.getLogger().info("Added " + amount + " to " + uuid + "'s balance. New balance: " + getBalance(uuid));
    }
    ...
    public static void takeBalance(@NotNull UUID uuid, double amount) {
        ...
        saveBalances();
        Bukkit.getLogger().info("Took " + amount + " from " + uuid + "'s balance. New balance: " + getBalance(uuid));
    }
    ...
    public static void deposit(@NotNull OfflinePlayer player, double amount) {
        ...
        Bukkit.getLogger().info("Deposited " + amount + " to player " + player.getName() + "'s account. New balance: " + getBalance(player));
    }
