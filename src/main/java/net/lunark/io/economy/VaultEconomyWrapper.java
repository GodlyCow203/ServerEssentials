...
public class VaultEconomyWrapper implements Economy {
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer player, double amount) {
        try {
            net.lunark.io.economy.EconomyResponse internal = economy.withdrawPlayer(player, amount);
    ...
    public EconomyResponse depositPlayer(OfflinePlayer player, double amount) {
        try {
            net.lunark.io.economy.EconomyResponse internal = economy.depositPlayer(player, amount);
            return convertResponse(internal);
        } catch (Exception e) {
    ...
    private EconomyResponse convertResponse(net.lunark.io.economy.EconomyResponse internal) {
