...
import net.lunark.io.commands.config.TeleportWorldConfig;
...
public final class TeleportWorldCommand implements CommandExecutor, TabCompleter {
    private static final String PERMISSION_NODE = "serveressentials.command.tpp";
    private static final String PERMISSION_OTHERS = "serveressentials.command.tpp.others";
    private static final String PERMISSION_WORLD_PREFIX = "serveressentials.command.tpp.world.";
