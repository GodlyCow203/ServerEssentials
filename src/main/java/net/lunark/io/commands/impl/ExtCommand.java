...
import net.lunark.io.commands.config.ExtConfig;
...
public final class ExtCommand implements CommandExecutor {
    private static final String PERMISSION_NODE = "serveressentials.command.ext";
    private static final String PERMISSION_OTHERS = "serveressentials.command.ext.others";
