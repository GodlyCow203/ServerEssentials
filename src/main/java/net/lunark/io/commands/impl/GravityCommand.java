...
import net.lunark.io.commands.config.GravityConfig;
...
public final class GravityCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String PERMISSION = "serveressentials.command.gravity";
    private static final String PERMISSION_OTHERS = "serveressentials.command.gravity.others";
