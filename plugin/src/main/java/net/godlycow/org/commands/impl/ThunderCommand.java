...
import net.godlycow.org.commands.config.ThunderConfig;
...
public final class ThunderCommand implements CommandExecutor, TabCompleter {
    ...
    private static final String PERMISSION = "essc.command.thunder";
    private static final String PERMISSION_OTHERS = "essc.command.thunder.others";
