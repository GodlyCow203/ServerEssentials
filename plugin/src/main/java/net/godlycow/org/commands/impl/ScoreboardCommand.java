...
public final class ScoreboardCommand implements CommandExecutor, TabCompleter {
    private static final String PERMISSION_BASE = "essc.command.scoreboard";
    private static final String PERMISSION_RELOAD = "essc.command.scoreboard.reload";
    private static final String PERMISSION_TOGGLE = "essc.command.scoreboard.toggle";
    private static final String PERMISSION_COLOR = "essc.command.scoreboard.color";
