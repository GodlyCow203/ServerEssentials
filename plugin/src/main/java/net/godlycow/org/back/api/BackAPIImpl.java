...
import com.serveressentials.api.back.BackLocationData;
...
public final class BackAPIImpl implements BackAPI {
    private static final String PERMISSION_BACK = "serveressentials.command.back";
    ...
    public BackAPIImpl(@NotNull ServerEssentials plugin,
